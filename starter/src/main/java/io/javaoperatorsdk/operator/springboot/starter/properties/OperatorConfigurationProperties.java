...
public class OperatorConfigurationProperties {
  ...
  public boolean equals(Object object){
    if (!(object instanceof OperatorConfigurationProperties that)) return false;
    return isCheckCrdAndValidateLocalModel() == that.isCheckCrdAndValidateLocalModel()
            ...
            && Objects.equals(getMinConcurrentReconciliationThreads(), that.getMinConcurrentReconciliationThreads())
            && Objects.equals(getConcurrentWorkflowExecutorThreads(), that.getConcurrentWorkflowExecutorThreads())
            && Objects.equals(getMinConcurrentWorkflowExecutorThreads(), that.getMinConcurrentWorkflowExecutorThreads())
            && Objects.equals(getCloseClientOnStop(), that.getCloseClientOnStop())
            && Objects.equals(getStopOnInformerErrorDuringStartup(), that.getStopOnInformerErrorDuringStartup())
  ...
  public int hashCode(){
    return Objects.hash(getCrd(), getClient(), getReconcilers(), isCheckCrdAndValidateLocalModel(),
            getConcurrentReconciliationThreads(), getMinConcurrentReconciliationThreads(), getConcurrentWorkflowExecutorThreads(),
            getMinConcurrentWorkflowExecutorThreads(), getCloseClientOnStop(), getStopOnInformerErrorDuringStartup(), getCacheSyncTimeout());
  }
}
