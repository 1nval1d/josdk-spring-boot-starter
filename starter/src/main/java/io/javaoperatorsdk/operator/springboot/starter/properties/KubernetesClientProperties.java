...
public class KubernetesClientProperties{
    ...
    public KubernetesClientProperties setTrustSelfSignedCertificates(boolean trustSelfSignedCertificates){
    ...
    public boolean equals(Object object){
        if (!(object instanceof KubernetesClientProperties that)) return false;
    ...
    @Override
    public int hashCode(){
        return Objects.hash(isOpenshift(), getContext(), getUsername(), getPassword(), getOauthToken(), getMasterUrl(), isTrustSelfSignedCertificates());
    }
}
